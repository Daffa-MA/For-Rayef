...
const popoutItems = [
  ...
  },
  {
    ...
    accent: '#5f84b8',
    width: 'clamp(5.8rem, 16vw, 8.4rem)',
    widthMobile: 'clamp(4.9rem, 18vw, 6.6rem)',
    aspectRatio: '3 / 4',
    aspectRatioMobile: '3 / 4',
    fit: 'cover',
    x: 'clamp(-13.2rem, -20vw, -9.2rem)',
    y: 'clamp(-2.4rem, -3vh, -0.8rem)',
    rotate: '-8deg',
    mobileX: 'clamp(-6.6rem, -20vw, -5.2rem)',
    mobileY: 'clamp(-2.2rem, -6vw, -1.2rem)',
    mobileRotate: '-8deg',
    delay: '220ms',
    z: 5,
  },
  {
    ...
    aspectRatioMobile: '3 / 4',
    fit: 'cover',
    x: 'clamp(9.2rem, 20vw, 13.2rem)',
    y: 'clamp(-2.4rem, -3vh, -0.8rem)',
    rotate: '8deg',
    mobileX: 'clamp(5.2rem, 20vw, 6.6rem)',
    mobileY: 'clamp(-2.2rem, -6vw, -1.2rem)',
    mobileRotate: '8deg',
    delay: '320ms',
    z: 4,
  },
  {
    ...
    widthMobile: 'clamp(4.4rem, 16vw, 5.8rem)',
    aspectRatio: '3 / 4',
    aspectRatioMobile: '3 / 4',
    fit: 'cover',
    x: 'clamp(-19rem, -28vw, -14.5rem)',
    y: 'clamp(2.6rem, 5vh, 5.2rem)',
    rotate: '-6deg',
    mobileX: 'clamp(-8.6rem, -27vw, -7.4rem)',
    mobileY: 'clamp(1.2rem, 4vw, 2.2rem)',
    mobileRotate: '-6deg',
    delay: '420ms',
    z: 3,
  },
  {
    ...
    aspectRatioMobile: '3 / 4',
    fit: 'cover',
    x: 'clamp(14.5rem, 28vw, 19rem)',
    y: 'clamp(2.6rem, 5vh, 5.2rem)',
    rotate: '6deg',
    mobileX: 'clamp(7.4rem, 27vw, 8.6rem)',
    mobileY: 'clamp(1.2rem, 4vw, 2.2rem)',
    mobileRotate: '6deg',
    delay: '520ms',
    z: 2,
  },
  {
    ...
    fit: 'cover',
    x: '0rem',
    y: 'clamp(10.4rem, 15vh, 13rem)',
    rotate: '0deg',
    mobileX: '0rem',
    mobileY: 'clamp(6.8rem, 17vw, 8.8rem)',
    mobileRotate: '0deg',
    delay: '620ms',
    z: 1,
  },
  {
    ...
    palette: ['#d6e3f4', '#f8fbff'],
    accent: '#6f94c5',
    width: 'clamp(5rem, 13.6vw, 6.6rem)',
    widthMobile: 'clamp(4.2rem, 15.5vw, 5.4rem)',
    aspectRatio: '3 / 4',
    aspectRatioMobile: '3 / 4',
    fit: 'cover',
    x: 'clamp(-12.2rem, -18vw, -9rem)',
    y: 'clamp(8.2rem, 11vh, 10.4rem)',
    rotate: '-5deg',
    mobileX: 'clamp(-5.9rem, -18vw, -4.8rem)',
    mobileY: 'clamp(4.8rem, 12vw, 6.2rem)',
    mobileRotate: '-5deg',
    delay: '700ms',
    z: 0,
  },
  {
    ...
    aspectRatioMobile: '3 / 4',
    fit: 'cover',
    x: 'clamp(9rem, 18vw, 12.2rem)',
    y: 'clamp(8.2rem, 11vh, 10.4rem)',
    rotate: '5deg',
    mobileX: 'clamp(4.8rem, 18vw, 5.9rem)',
    mobileY: 'clamp(4.8rem, 12vw, 6.2rem)',
    mobileRotate: '5deg',
    delay: '780ms',
    z: 0,
